...
const PERMISSIONS = {
  ...
  BOOKING_SEND_STAFF_PROFILE:  { label: 'Send Staff Profile to Client',     module: 'Bookings', entity: 'Staff Assignment',  verb: 'Send Staff Profile',        category: 'action' },
  ...
  STAFF_PORTAL_ACCESS:         { label: 'Enable/Disable Staff Dashboard Access', module: 'User Management', entity: 'Staff (Nursing) Account', verb: 'Portal Access', category: 'action' },
  ...
  STAFF_APPLY_BONUS:           { label: 'Apply Staff Bonus',                module: 'User Management', entity: 'Staff Payout',            verb: 'Apply Bonus',   category: 'action' },
...
const ROLE_TEMPLATES = {
  COORDINATOR: [
    ...
    'BOOKING_SEND_STATEMENT', 'BOOKING_SEND_STAFF_PROFILE', 'BOOKING_EXTEND', 'BOOKING_COMPLETE', 'BOOKING_TERMINATE',
    ...
    'STAFF_EDIT', 'STAFF_DEACTIVATE', 'STAFF_REACTIVATE', 'STAFF_PORTAL_ACCESS',
  ...
  ACCOUNTS: [
    ...
    'STAFF_CREATE_PAYOUT', 'STAFF_APPLY_DEDUCTION', 'STAFF_APPLY_BONUS', 'STAFF_DEACTIVATE', 'STAFF_REACTIVATE', 'STAFF_PORTAL_ACCESS',
