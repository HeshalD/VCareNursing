...
router.get('/admin/bookings/:client_id', requirePermission('VIEW_STAFF_REVIEWS'), staffReviewController.getClientBookingsForAdmin);
router.get('/admin/booking/:booking_id/staff', requirePermission('VIEW_STAFF_REVIEWS'), staffReviewController.getBookingStaffForReview);
