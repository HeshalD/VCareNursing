...
exports.upsertAttendance = async (req, res) => {
    const { booking_id } = req.params;
    const { assignment_id, service_date, in_time, out_time, notes } = req.body;
    ...
    try {
        const assignmentCheck = await db.query(
            `SELECT assignment_id, staff_profile_id FROM booking_staff_assignments
        ...
        const result = await db.query(
            ...
            ON CONFLICT (assignment_id, service_date)
