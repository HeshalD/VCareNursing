                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-1 text-slate-600">
                            ...
                            <span className="text-xs">
                              {req.start_date ? new Date(req.start_date).toLocaleDateString('en-GB') : '—'}
                            </span>
                          </div>
                        </td>
                        <td className="px-5 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-slate-900">
                      {selectedRequest.start_date ? new Date(selectedRequest.start_date).toLocaleDateString('en-GB') : '—'}
                    </p>
                  </div>
                </div>
              </div>
